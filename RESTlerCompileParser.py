...
class Parser(Transformer):
    ...
    #         print("1", fuzz_dict)  # Debug print
            
    #         # 检查 fuzz_dict 是字典还是列表
    #         if isinstance(fuzz_dict, dict):
    #             for key in fuzz_dict:
    #                 print("1", key)  # Debug print
    #                 if isinstance(fuzz_dict[key], list):
    #                     fuzz_dict_ans[key] = ["Array"]
    #                     for ele in fuzz_dict[key]:
    #                         fuzz_dict_ans[key].append(["String", [], ele])
    ...
    #         # 如果 fuzz_dict 是列表，而不是字典
    #         elif isinstance(fuzz_dict, list):
    #             fuzz_dict_ans = ["Array"]
    #             for ele in fuzz_dict:
    #                 fuzz_dict_ans.append(["String", [], ele])
    #             return (fuzz_dict_ans, "Array")
            
    #         # 其他情况（如数字、布尔值等）
    #         else:
    #             return (["String", [], str(fuzz_dict)], "String")
